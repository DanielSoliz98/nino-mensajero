...
<body class="body-content-formal">
    <section>
        <nav class="navbar navbar-expand-lg navbar-light bg-info navbar-toggleable-md sticky-top backcolor-formal">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <a href="{{route('page')}}" class="btn3"><i class="fas fa-user-friends"></i> ¿Quiénes Somos?</a>
                </div>
            </div>
        </nav>
        @yield('section')
