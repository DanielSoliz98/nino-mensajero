                        ...
                        <div class="row">
                            ...
                            <div class="col-3 d-flex justify-content-end">
                                <div class="card-text text-muted">
                                    @if(count($letter->filename) == 1)
                                        <span class="badge badge-light">{{$letter->filename->count()}} imagen</span>
                                    @else
                                        <span class="badge badge-light">{{$letter->filename->count()}} imágenes</span>
                                    @endif
